 ...
 * 
 */
@WebServiceClient(name = "RoutingService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8001/RoutingService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8001/RoutingService?wsdl");
